...
class handDetector():
    def __init__(self, mode=False, model_complexity=1,maxHands=2,
                 detectionCon=0.5,
        ...
        self.hands = self.mpHands.Hands(self.mode, self.model_complexity,
                                        self.maxHands,
                                        self.detectionCon,
                                        self.trackCon)
    ...
    def findHands(self, img, draw=True):
        ...
        if self.results.multi_hand_landmarks:
            ...
            for handLms in self.results.multi_hand_landmarks:
                # each hand landmarks in results
                if draw:
    ...
    def fingersUp(self):  # checking which finger is open
        ...
        # Fingers
        for id in range(1,
                        5):  # checking tip point is below tippoint-2
            # (only in Y direction)
...
def main():
    ...
    while True:
        ...
        # FPS
        PTime = CTime
        # previous time is replaced by current time
